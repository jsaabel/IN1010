...
class Brett {
	...
	return ruter[r1].merke==c && ruter[r2].merke==c && ruter[r3].merke==c;
    }
    ...
    void skrivBrettlinje(int p1, int p2, int p3) {
	System.out.println("| " + ruter[p1] + " | " +
	    ruter[p2] + " | " + ruter[p3] + " |");
    }

    void skriv() {
	skrivHorLinje();
	skrivBrettlinje(1, 2, 3);
	skrivHorLinje();
	skrivBrettlinje(4, 5, 6);
	skrivHorLinje();
	skrivBrettlinje(7, 8, 9);
	skrivHorLinje();
    }
}
